    ...
    <div class="sticky top-[20vh]
        ...
        <a href="http://localhost/logout">
            <form method="POST" action="{{ route('logout') }}">
                @csrf
                <button type="submit" class="flex justify-between items-center mt-4 mb-4 h-[55px] w-[85%] m-auto p-1
                                            bg-none hover:bg-red-100 rounded-lg border-4 border-transparent hover:border-red-500 text-red-500">
