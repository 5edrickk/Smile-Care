                            ...
                            @foreach ($services as $service)
                                @if ($service->id_type == $categorie->id )
                                    <p class="pl-3 m-1 flex">🦷 {{ $service->name }}
                                        <a href="{{ route('services.edit', ['id' => $service->id])}}" class="w-[2.5%] ml-3 flex justify-center align-middle">
                                        ...
                                        <a href="{{ route('services.destroy', $service->id) }}" class="w-[2.5%] mx-2 flex justify-center align-middle">
